...
class AdminNotice {
    ...
    function magnitude_dashboard_notice_content(){
		if ( file_exists( WP_PLUGIN_DIR . '/af-companion/af-companion.php' ) ) {
            $af_companion_title = __( 'Activate AF Companion', 'magnitude' );
            ...
            $af_companion_title = __( 'Install AF Companion', 'magnitude' );
		...
		$demo_link = "https://afthemes.com/products/magnitude/";
		...
		$notice_external_msg =sprintf(
			...
			esc_html__( 'Return to your dashboard', 'magnitude' )
