...
class AF_Theme_info{
		...
		public function magnitude_register_info_page() {
			...
			// Add info page.
			add_theme_page( $this->menu_name, $this->page_name, 'activate_plugins', $this->page_slug, array( $this, 'magnitude_render_page' ), 1 );
		}
...
$aft_dashboard = new AF_Theme_info;
